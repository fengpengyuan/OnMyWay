...
public class YelpAPI {
	 ...
	 */
	private static final String CONSUMER_KEY = "XDpB0Y3DdL-o4PksIr5wrg";
	private static final String CONSUMER_SECRET = "x3tpsyMN5AgNOysRsUM0phaCTeI";
	private static final String TOKEN = "E_bpMvVFZGf7-Ye_hIx0QlI8zagzlFeG";
	private static final String TOKEN_SECRET = "-o4ZkwaSnu-WIKlwbhGMCn2U7uA";
	...
	// yelpApi.searchForBusinessesByLocation(yelpApiCli.term,
	// yelpApiCli.location);
	//
	...
	public static void main(String[] args) {
		...
		String response = yelpApi.searchForBusinessesByLocation("Gas", "98125");

		class JSONComparator implements Comparator<JSONObject> {
			@Override
			public int compare(JSONObject a, JSONObject b) {
				double valA = 0.0, valB = 0.0;
				// valA and valB could be any simple type, such as number,
				// string, whatever
				try {
					valA = Double.parseDouble(a.getString("ratings"));
				} catch (NumberFormatException | JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				try {
					valB = Double.parseDouble(b.getString("ratings"));
				} catch (NumberFormatException | JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
...
//				System.out.println(businesses.getString(i));
//				jsonValues.add(new JSONObject(businesses.getString(i)));
//			}
//			Collections.sort(jsonValues, new JSONComparator());
			...
			//
			 ...
			 business.getString("mobile_url"));
			 System.out.println("phone: " + business.getString("phone"));
			 JSONArray address =
			 business.getJSONObject("location").getJSONArray("display_address");
			...
			// JSONObject business = sortedJsonArray.getJSONObject(i);
			// System.out.println("name: " + business.getString("name"));
			// System.out.println("rating: " + business.getString("rating"));
			// System.out.println("mobile_url: " +
			// business.getString("mobile_url"));
